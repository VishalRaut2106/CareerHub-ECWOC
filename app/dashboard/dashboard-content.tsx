    ...
    <main className="min-h-screen bg-background fade-in">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Button
              ...
              variant="ghost"
              className="text-foreground hover:bg-foreground/10 gap-2"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="space-y-8 slide-up">
          <Link href={'/'} className="glassmorphic p-2 rounded-2xl border-foreground/10 flex gap-2 items-center px-5 w-fit cursor-pointer">
          ...
          <div className="glassmorphic p-8 rounded-2xl border-foreground/10">
            ...
            <p className="text-muted-foreground">
              Find your next opportunity in jobs, scholarships, or internships.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                title: "Browse Jobs",
                description: "Latest job postings updated daily",
                icon: "💼",
              },
              {
          ...
          <div className="glassmorphic p-6 rounded-2xl border-foreground/10">
            <div className="flex gap-3">
              ...
              <Button className="glassmorphic-button-primary text-foreground">
                Search
              </Button>
            </div>
          </div>
